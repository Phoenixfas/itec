...
export default function BecomeSponsor() {
  ...
  return (
    <div style={{minHeight: "100vh", paddingTop: "50px"}} id='sponsor' className={`${style.booking}`}>
        <div className={style.bookingForm}>
            <h1>Become a Sponsor at AMEC</h1>
            ...
            <form onSubmit={onSubmit}>
                ...
                <div className={style.formInput}>
                    ...
                    <select name="goal" id="goal" placeholder='(Required)' required value={goal} onChange={(e) => setGoal(e.target.value)}>
