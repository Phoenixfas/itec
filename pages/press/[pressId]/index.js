...
export async function getServerSideProps(context) {
    const { pressId } = context.query;
    const blog = await fetch(`https://dashboard.afriopia.com/api/press/${pressId}`)
        .then((res) => res.json())
        .then((data) => data.data)
