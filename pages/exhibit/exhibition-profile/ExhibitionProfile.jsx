...
import exProfiles from '../../../data/exProfiles'
  ...
  return (
    <div style={{paddingTop: "100px"}} className={style.blogs}>
        ...
        <div style={{gap: "100px", maxWidth: "1200px"}} className={style.blogs__list}>
            {exProfiles && exProfiles?.map((profile, index) => (
                <div key={index} className={style.blog__item}>
                    <Image src={profile.image} alt="Exhibition Profile" width={500} height={200} quality={100} priority />
